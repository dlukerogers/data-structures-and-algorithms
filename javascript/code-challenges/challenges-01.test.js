...
const createList = (availableItems) => {
  ...
  // foreach - go through the inventory and find the items that have available: true
  // then I need to get the value of name and push it onto my arrToReturn array
